...
ALLOWED_HOSTS = env.list('ALLOWED_HOSTS', default=['nandkumarsanodiya@gmail.com'])
...
DEFAULT_FROM_EMAIL = env(
    'DEFAULT_FROM_EMAIL',
    default='Bootcamp <nandkumarsanodiya@gmail.com>'
)
...
EMAIL_PORT = 465
EMAIL_HOST_USER = 'nandkumarsanodiya@gmail.com'
EMAIL_HOST_PASSWORD = 'shivkumari'
#EMAIL_USE_TLS = True
EMAIL_USE_SSL = True